...
def GeneratePDF(request):
    ...
    titulo = 'PREVISÃO DA ESCALA DE SERVIÇO'
    subtitulo = ' PARA O MÊS DE '
    nomeArquivo = 'Previsao de Escala de Serviços em: '+ datetime.now().strftime("%d/%m/%Y") + '.pdf'

    return gerarPDF(request, sqlmilitar,titulo,nomeArquivo, subtitulo)
